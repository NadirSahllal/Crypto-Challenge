...
The code is done in C++. 
 ...
 As to give a more in detail explaination a bout the code:
 The code is relatively hard to understand, that is mainly coz it is used for a security challenge.
